...
//initialize preferences
    ...
    private String sharedPrefFile = "android.hellosharedprefs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //RESTORE RPEFERENCES FROM LAST SAVED:
        //get count from preferences with COUNTKEY & assign to mCount variable
        mCount = mPreferences.getInt(COUNT_KEY, 0);

        //update value of main TextView with new count
        mShowCountTextView.setText(String.format("%s",mCount));

        //get colour form preferences with COLOR_KEY & assign to mColor variable
        mColor = mPreferences.getInt(COLOR_KEY, mColor);

        //update bg color of main text
   ...
   /*     if (savedInstanceState != null) {
    ...
    @Override //save preferences in onPause()
    protected  void onPause(){
        ...
        //call apply to save preferences
    ...
    public void reset(View view) {
        ...
        //CLEAR PREFERENCES
        // after the color and count are reset, get an editor for SharedPreferences object:
        SharedPreferences.Editor preferencesEditor = mPreferences.edit();
